...
async function deleteWorkspace(db, wsId, currentUid) {
    ...
    try {
        dmsSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDocs"])(wsDmsCol(db, wsId));
    } catch (err) {
...
async function updateWsMessage(db, wsId, msgId, fields) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(wsMessagesCol(db, wsId), msgId), fields, {
        merge: true
    });
}
...
async function updateDmMessage(db, wsId, channelId, msgId, fields) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(wsDmMessagesCol(db, wsId, channelId), msgId), fields, {
        merge: true
    });
}
}),
...
function AppProvider({ children }) {
    ...
    const deleteWorkspaceActionFn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (wsId)=>{
        ...
        const wsName = state.workspaces.find((w)=>w.workspaceId === wsId)?.name || "Workspace";
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteWorkspace"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], wsId, state.user?.uid);
    ...
    const renameWorkspaceActionFn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (wsId, newName)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"]) return;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateWorkspace"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], wsId, {
            name: newName,
            updatedAt: new Date().toISOString()
        });
        dispatch({
    ...
    const sendMessageAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((text, attachment, attachments)=>{
    ...
    const sendDmAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((text, attachment, attachments)=>{
        if (!state.user || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.activeDmUserId) return;
        if (!text.trim() && !attachment && (!attachments || attachments.length === 0)) return;
        const channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDmChannelId"])(state.user.uid, state.activeDmUserId);
        const msg = {
    ...
    const editMessageAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((msgId, newText)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
        const isDmActive = state.activeDmUserId !== null;
        if (isDmActive) {
            const channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDmChannelId"])(state.user.uid, state.activeDmUserId);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDmMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, channelId, msgId, {
                text: newText.trim(),
                editedAt: new Date().toISOString()
            });
        } else {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateWsMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, msgId, {
                text: newText.trim(),
                editedAt: new Date().toISOString()
            });
        }
    ...
    const deleteMessageForMeAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((msgId)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
        const isDmActive = state.activeDmUserId !== null;
    ...
    const deleteMessageForEveryoneAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((msgId)=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
        const isDmActive = state.activeDmUserId !== null;
        const fields = {
            text: "",
            attachment: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteField"])(),
            attachments: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteField"])(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a6ffa02._.js.map