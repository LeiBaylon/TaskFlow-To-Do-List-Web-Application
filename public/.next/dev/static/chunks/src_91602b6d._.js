...
async function deleteWorkspace(db, wsId, currentUid) {
...
async function updateWsMessage(db, wsId, msgId, fields) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(wsMessagesCol(db, wsId), msgId), fields, {
        merge: true
    });
}
...
async function updateDmMessage(db, wsId, channelId, msgId, fields) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(wsDmMessagesCol(db, wsId, channelId), msgId), fields, {
        merge: true
    });
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function AppProvider({ children }) {
    ...
    const deleteWorkspaceActionFn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteWorkspaceActionFn]": async (wsId)=>{
            ...
            const wsName = state.workspaces.find({
                "AppProvider.useCallback[deleteWorkspaceActionFn]": (w)=>w.workspaceId === wsId
            }["AppProvider.useCallback[deleteWorkspaceActionFn]"])?.name || "Workspace";
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteWorkspace"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], wsId, state.user?.uid);
            ...
            dispatch({
                type: "SHOW_TOAST",
                payload: {
                    message: `"${wsName}" has been deleted`,
                    type: "success"
                }
            });
        }
    ...
    const renameWorkspaceActionFn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[renameWorkspaceActionFn]": async (wsId, newName)=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"]) return;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWorkspace"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], wsId, {
                name: newName,
                updatedAt: new Date().toISOString()
            });
            dispatch({
    ...
    }["AppProvider.useCallback[renameWorkspaceActionFn]"], []);
    ...
    const sendMessageAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[sendMessageAction]": (text, attachment, attachments)=>{
    ...
    const sendDmAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[sendDmAction]": (text, attachment, attachments)=>{
            if (!state.user || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.activeDmUserId) return;
            if (!text.trim() && !attachment && (!attachments || attachments.length === 0)) return;
            const channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDmChannelId"])(state.user.uid, state.activeDmUserId);
            const msg = {
    ...
    const editMessageAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[editMessageAction]": (msgId, newText)=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
            const isDmActive = state.activeDmUserId !== null;
            if (isDmActive) {
                const channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDmChannelId"])(state.user.uid, state.activeDmUserId);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDmMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, channelId, msgId, {
                    text: newText.trim(),
                    editedAt: new Date().toISOString()
                });
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWsMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, msgId, {
                    text: newText.trim(),
                    editedAt: new Date().toISOString()
                });
            }
        }
    }["AppProvider.useCallback[editMessageAction]"], [
        state.user,
        state.activeWorkspaceId,
        state.activeDmUserId
    ]);
    const deleteMessageForMeAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteMessageForMeAction]": (msgId)=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
            const isDmActive = state.activeDmUserId !== null;
            // Find the message to get current deletedFor
            const msgs = isDmActive ? state.dmMessages : state.workspaceMessages;
            const msg = msgs.find({
                "AppProvider.useCallback[deleteMessageForMeAction].msg": (m)=>m.id === msgId
            }["AppProvider.useCallback[deleteMessageForMeAction].msg"]);
    ...
    }["AppProvider.useCallback[deleteMessageForMeAction]"], [
        state.user,
        state.activeWorkspaceId,
        state.activeDmUserId,
        state.dmMessages,
    ...
    const deleteMessageForEveryoneAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AppProvider.useCallback[deleteMessageForEveryoneAction]": (msgId)=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"] || !state.activeWorkspaceId || !state.user) return;
            const isDmActive = state.activeDmUserId !== null;
            const fields = {
                text: "",
                attachment: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteField"])(),
                attachments: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteField"])(),
                deletedForEveryone: true
            };
            if (isDmActive) {
                const channelId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDmChannelId"])(state.user.uid, state.activeDmUserId);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDmMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, channelId, msgId, fields);
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$workspace$2d$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateWsMessage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], state.activeWorkspaceId, msgId, fields);
            }
        }
    }["AppProvider.useCallback[deleteMessageForEveryoneAction]"], [
        state.user,
        state.activeWorkspaceId,
        state.activeDmUserId
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            ...
            const timer = setTimeout({
                "AppProvider.useEffect.timer": ()=>dispatch({
                        type: "CLEAR_TOAST"
                    })
            }["AppProvider.useEffect.timer"], 4000);
            return ({
...
_s1(AppProvider, "APvS5Nam70xoaOYAjvGpSLuQtzU=");
_c = AppProvider;
var _c;
...
//# sourceMappingURL=src_91602b6d._.js.map