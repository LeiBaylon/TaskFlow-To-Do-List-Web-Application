  ...
  return (
    ...
    >
      <button
        ...
        style={{
          color:
            item.danger ? "var(--color-danger)" : "var(--color-text-primary)",
      ...
      >
        ...
        {item.shortcut && (
          <span className="text-[11px] ml-4 opacity-40 font-mono">
            {item.shortcut}
          </span>
        )}
        {hasChildren && <ChevronRight size={12} style={{ opacity: 0.4 }} />}
      </button>
